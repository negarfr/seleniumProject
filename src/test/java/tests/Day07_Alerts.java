...
//        click OK ,
        driver.switchTo().alert().accept(); // accept() means click here
...
//    verify text "I am a JS Confirm”,
        String actualDissmisAlert = driver.switchTo().alert().getText();
        assertEquals("I am a JS Confirm", actualDissmisAlert);
...
//    verify text “I am a JS prompt”,
       String actualAlertText =  driver.switchTo().alert().getText();  // this will return text on the alert
